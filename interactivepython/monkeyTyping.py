...
if __name__ == '__main__':
    ...
    assert monkeyTyping("How aresjfhdskfhskd you?", {"how", "are", "you", "hello"}) == 3, "Example"
    assert monkeyTyping("Bananas, give me bananas!!!", {"banana", "bananas"}) == 2, "BANANAS!"
    assert monkeyTyping("Lorem ipsum dolor sit amet, consectetuer adipiscing elit.", {"sum", "hamlet", "infinity", "anything"}) == 1, "Weird text"